        ...
        <form @submit.prevent="submitHandler">
            <div class="card">
                ...
                <div class="card-body card_body_fixed_height">
                    <div class="row">
                        <input type="hidden" name="role_serial" value="9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" v-for="(form_field, index) in work_information_fields" :key="index">
                            <common-input
                                :label="form_field.label"
                                :type="form_field.type"
                                :name="form_field.name"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <hr>
                            Employee Dependent Infos
                        </div>
                        <div class="col-md-6" v-for="(form_field, index) in dependent_fields" :key="index">
                            <common-input
                                :label="form_field.label"
                                :type="form_field.type"
                                :name="form_field.name"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <hr>
                            Employee Reference Infos
                        </div>
                        <div class="col-md-6" v-for="(form_field, index) in reference_fields" :key="index">
                            <common-input
                                :label="form_field.label"
                                :type="form_field.type"
                                :name="form_field.name"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <hr>
                            Employee Educational Infos
                        </div>
                        <div class="col-md-6" v-for="(form_field, index) in education_fields" :key="index">
                            <common-input
                                :label="form_field.label"
                                :type="form_field.type"
                                :name="form_field.name"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <hr>
                            Employee Experience Infos
                        </div>
                        <div class="col-md-6" v-for="(form_field, index) in experience_fields" :key="index">
                            <common-input
                                :label="form_field.label"
                                :type="form_field.type"
                                :name="form_field.name"
...
import form_fields from "./setup/form_fields/form_fields";
import reference_fields from "./setup/form_fields/reference_fields";
import dependent_fields from "./setup/form_fields/dependent_fields";
import education_fields from "./setup/form_fields/education_fields";
import experience_fields from "./setup/form_fields/experience_fields";
import work_information_fields from "./setup/form_fields/work_information_fields";
