                        ...
                        <table class="table table-hover text-center table-bordered">
                            ...
                            <tbody v-if="data.length">
                                <tr v-for="(item, index) in data" :key="item.id">
                                    ...
                                    <th>
                                        <img :src="'https://ctgcomputer.com/'+item.category_image" alt="" height="40" width="40">
                                    </th>
                                    <th> {{ item.name }} </th>
                                    <th>
                                        <input :checked="item.is_nav_category" class="form-check-input" type="checkbox">
                                    </th>
                                    <th>
                                        <input :checked="item.is_top_category" type="checkbox" class="form-check-input">
                                    </th>
                                    <td>
...
export default {
    ...
    created: function () {
        axios.get('https://ctgcomputer.com/api/all-cats')
            .then(res=>{
                this.data = res.data;
            })
        // this.get_all_data()
